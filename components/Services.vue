<template>
	<div class="container py-7" id="service">
		<div class="mw-3 m-auto">
			...
			<div class="row align-items-center mb-7 pb-7">
				...
				<div class="col-12 col-md-6 order-1 order-md-2 p-4">
					<object type="image/svg+xml" data="svg/undraw_fast_loading_0lbh.svg" id="grid1"></object>	
				</div>
			</div>
			<div class="row align-items-center mb-7">
				...
				<div class="col-12 col-md-6 order-1 p-4">
					<object type="image/svg+xml" data="svg/undraw_usability_testing_2xs4.svg" id="grid1"></object>
				</div>
			</div>
			<div class="row align-items-center mb-7">
				<div class="col-12 col-md-6 order-2 order-md-1">
				...
				<div class="col-12 col-md-6 order-1 order-md-2 p-4">
					<object type="image/svg+xml" data="svg/undraw_web_devices_ad58.svg" id="grid1"></object>
				</div>
			</div>
		</div>
	</div>
